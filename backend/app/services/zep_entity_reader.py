...
class ZepEntityReader:
    ...
    def _call_with_retry(
        ...
        Args:
            func: The function to execute (a parameterless lambda or callable)
    ...
    def get_all_nodes(self, graph_id: str) -> List[Dict[str, Any]]:
        """
        Retrieve all nodes from the graph (with pagination)
    ...
    def get_all_edges(self, graph_id: str) -> List[Dict[str, Any]]:
        """
        Retrieve all edges from the graph (with pagination)
    ...
    def get_node_edges(self, node_uuid: str) -> List[Dict[str, Any]]:
        """
        Retrieve all related edges for a given node (with retry mechanism)
    ...
    def get_entity_with_context(
        ...
        """
        Retrieve a single entity with its full context (edges and related nodes, with retry mechanism)
