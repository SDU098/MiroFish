    ...
    def prepare_simulation(
        ...
        try:
            ...
            if filtered.filtered_count == 0:
                ...
                state.error = "No matching entities found. Please verify that the knowledge graph is correctly built."
                self._save_simulation_state(state)
                return state
            ...
            # Reddit profiles are already saved in real-time during generation; save again here for completeness
            if progress_callback:
                progress_callback(
            ...
            # ========== Phase 3: LLM-powered intelligent simulation config generation ==========
            if progress_callback:
                progress_callback(
                    "generating_config", 0,
