...
This script reads parameters from a configuration file to execute simulations in a fully automated manner.

Features:
- Does not immediately shut down the environment after simulation completes; enters command-waiting mode
...
async def main():
    ...
    parser.add_argument(
        ...
        action='store_true',
        default=False,
        help='Shut down environment immediately after simulation completes, without entering command-waiting mode'
    )

    args = parser.parse_args()

    # Create shutdown event at the start of the main function
...
def setup_signal_handlers():
    ...
    Gives the program a chance to gracefully clean up resources (close database, environment, etc.)
    """
